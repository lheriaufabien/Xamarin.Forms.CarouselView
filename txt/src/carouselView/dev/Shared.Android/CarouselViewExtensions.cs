...
using Android.Views;
using BatMobile.SDK.Controls.CarouselViewForms;
using System;
...
using ItemsView = BatMobile.SDK.Controls.CarouselViewForms.ItemView;
...
[assembly: ExportRenderer(typeof(CarouselViewForm.CarouselView), typeof(CarouselViewForms.Droid.Renderers.CarouselViewRenderer))]
namespace CarouselViewForms.Droid.Renderers
{
    ...
    internal class PhysicalLayoutManager : LayoutManager
    {
        ...
        internal struct DecoratedView
        {
            ...
            private readonly PhysicalLayoutManager _layout;
        ...
        private sealed class SeekAndSnapScroller : LinearSmoothScroller
        {
            #region Fields

            private readonly SnapPreference _snapPreference;
            private readonly Func<int, IntVector> _vectorToPosition;
        ...
        private enum AdapterChangeType
        {
            Removed = 1,
            Added,
            Moved,
        ...
        #endregion Private Defintions

        #region Static Fields

        private static readonly int s_samplesCount = 5;
        ...
        private readonly VirtualLayoutManager _virtualLayout;
        private readonly Queue<Action<Recycler, State>> _deferredLayout;
        private readonly Dictionary<int, AndroidView> _viewByAdaptorPosition;
        private readonly HashSet<int> _visibleAdapterPosition;
        private readonly SeekAndSnapScroller _scroller;

        private int _positionOrigin; // coordinates are relative to the upper left corner of this element
        private IntVector _locationOffset; // upper left corner of screen is positionOrigin + locationOffset
        private List<IntVector> _samples;
        private AdapterChangeType _adapterChangeType;
        ...
        private void OffsetChildren(IntVector delta)
        {
            OffsetChildrenHorizontal(-delta.X);
            OffsetChildrenVertical(-delta.Y);
        }

        private void ScrollBy(ref IntVector delta, Recycler recycler, State state)
        {
    ...
    internal class ItemViewAdapter : Adapter
    {
        ...
        private class CarouselViewHolder : ViewHolder
        {
            #region Fields

            private readonly View _view;
            private readonly IVisualElementRenderer _visualElementRenderer;
        ...
        private readonly Dictionary<int, object> _typeByTypeId;
        ...
        private IItemViewController Controller => Element;
        ...
        public override ViewHolder OnCreateViewHolder(ViewGroup parent, int viewType)
        {
            ...
            var renderer = Platform.CreateRendererWithContext(view, parent.Context);
    ...
    public class CarouselViewRenderer : ViewRenderer<CarouselViewForms.CarouselView, RecyclerView>
    {
        ...
        internal class VirtualLayoutManager : PhysicalLayoutManager.VirtualLayoutManager
        {
            ...
            private IntSize _itemSize;

            #endregion Fields

            #region Private Members

            private int GetPosition(int itemCount, int positionOrigin, int x, bool exclusive = false)
            {
        ...
        {
            private readonly Func<int> _visibleViewCount;

            private readonly Action _onDragEnd;

            private readonly Action _onDragStart;

            private readonly Action _onScrollSettled;

            private ScrollState _lastScrollState;
        ...
        private class PositionUpdater : Observer
        {
            #region Fields

            private readonly CarouselViewRenderer _carouselView;
        ...
        private PhysicalLayoutManager _physicalLayout;
    ...
    internal struct MeasureSpecification
    {
        ...
        private readonly MeasureSpecificationType _type;
